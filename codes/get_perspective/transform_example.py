...
def transfer(image, coords)
	# image=cv2.imread("image_7.jpg", 0)
	...
	# coords="[(940, 1113), (1734, 2136), (1553, 1036), (1093, 2225)]"
	# pts = np.array(eval("[(940, 1113), (1734, 2136), (1553, 1036), (1093, 2225)]"), dtype = "float32")
